...
Element.paint = function( self )
    ...
    if self.data.horizontal then
        render_drawRectFast( self.data.positionGlobal.x + self.data.thumbOffset, self.data.positionGlobal.y, self.data.thumbLength, self.data.sizeGlobal.h )
    else
        render_drawRectFast( self.data.positionGlobal.x, self.data.positionGlobal.y + self.data.thumbOffset, self.data.sizeGlobal.w, self.data.thumbLength )
    end
end
